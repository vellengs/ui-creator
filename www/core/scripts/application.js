        ...
        bootstrap: function (settings) {
            settings.routers = {
                'app': {
                    ...
                    abstract: true,
                    controller: 'demo.master', //master page 定义的controller
                    dependencies: [
                ...
                'app.home': {
                    url: '/home',
                    templateUrl: settings.templates.home,
                    controller: "app.login",
                    dependencies: [
            ...
            function setPageTemplate(params) {
                ...
                var routerCases = {
                    1: ['plugins', 'default', 'pages', params.name].join('/'),  // 如 /dashboard
            ...
            function regFormCtrl(p, name) {
                ...
                p.addMapping(
                    'bootstrapDecorator',
                    name,
                    "plugins/default/templates/forms/" + snakeCase(name, '-') + ".html"
                );
                p.createDirective(
                    name,
                    "plugins/default/templates/forms/" + snakeCase(name, '-') + ".html"
